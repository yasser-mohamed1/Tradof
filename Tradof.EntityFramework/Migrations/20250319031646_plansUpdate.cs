        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReasonRating = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TechnicalSupports_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SupporterId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SupportTickets_TechnicalSupports_SupporterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanySubscriptions_Packages_PackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FreelancerLanguagesPairs", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FreelancerLanguagesPairs_Languages_LanguageFromId",
                        column: x => x.LanguageFromId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FreelancerLanguagesPairs_Languages_LanguageToId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FreelancerSocialMedias", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FreelancerId = table.Column<long>(type: "bigint", nullable: false),
                    PaymobToken = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModificationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatedToId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModificationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Ratings_AspNetUsers_RatedToId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropsalAttachments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PropsalAttachments_Proposals_ProposalId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<long>(type: "bigint", nullable: false),
                    ProjectPaymentId = table.Column<long>(type: "bigint", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModificationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentProcess_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymobResponse = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModificationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanySubscriptions_PackageId",
                table: "CompanySubscriptions",
                column: "PackageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FreelancerLanguagesPairs_FreelancerId",
                table: "FreelancerLanguagesPairs",
                column: "FreelancerId");

            migrationBuilder.CreateIndex(
                name: "IX_FreelancerLanguagesPairs_LanguageFromId",
                table: "FreelancerLanguagesPairs",
                column: "LanguageFromId");

            migrationBuilder.CreateIndex(
                name: "IX_FreelancerLanguagesPairs_LanguageToId",
                table: "FreelancerLanguagesPairs",
                column: "LanguageToId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_ProjectPaymentId",
                table: "Invoices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentProcess_FreelancerId",
                table: "PaymentProcess",
                column: "FreelancerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_LanguageFromId",
                table: "Projects",
                column: "LanguageFromId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_LanguageToId",
                table: "Projects",
                column: "LanguageToId");

            migrationBuilder.CreateIndex(
                name: "IX_Projects_SpecializationId",
                table: "Projects",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropsalAttachments_ProposalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_RatedToId",
                table: "Ratings",
                column: "RatedToId");

            migrationBuilder.CreateIndex(
                name: "IX_SupportTickets_SupporterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TechnicalSupports_UserId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Invoices_ProjectPayment_ProjectPaymentId",
                table: "Invoices",
                column: "ProjectPaymentId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PaymentProcess_ProjectPayment_PaymentId",
                table: "PaymentProcess",
                column: "PaymentId",
                principalTable: "ProjectPayment",
                principalColumn: "Id",
